      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="Registration updated.php">પ્રવેશ</a></li>
            <li><a href="#">રજીસ્ટ્રેશન</a></li>
            <li><a href="#">અમારા બારમાં</a></li>
            <li><a href="#">હેલ્પ</a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="" style="color:#333;">Progress part</a></li>
            <li class="active"><a href="Guest_new_2.php">પ્રથમ ચરણ</a></li>
