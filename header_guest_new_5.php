      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="Registration update.php">Registration</a></li>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php">પ્રવેશ</a></li>
          ...
          <ul class="nav nav-sidebar">
            ...
            <li><a href="Guest_new_4.php">ત્રિજુ ચરણ</a></li>
            <li class="active"><a href="">છેલ્લા ચરણ</a></li>
          </ul>
		  <ul class="nav nav-sidebar">
