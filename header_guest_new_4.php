    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Vernacular Search</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="#">હોમ પેજ <span class="sr-only">(current)</span></a></li>
            <li><a href="Login_page.php">પ્રવેશ</a></li>
            <li><a href="Registration update.php">રજીસ્ટ્રેશન</a></li>
            <li><a href="About.php">અમારા બારમાં</a></li>
            <li><a href="Help.php">હેલ્પ</a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="" style="color:#333;">Progress part</a></li>
            <li><a href="Guest_new_2.php">પ્રથમ ચરણ</a></li>
            <li><a href="Guest_new_3.php">બીજું ચરણ</a></li>
            <li class="active"><a href="Guest_new_4.php">ત્રિજુ ચરણ</a></li>
