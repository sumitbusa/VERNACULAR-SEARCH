    ...
    <div class="jumbotron">
      <div class="container" style="margin-left:15%;">
		<form method="post" action="Translator.php" name="f1">
			...
			<p style="left:15%"><a class="btn btn-primary btn-lg" href="Guest_new_2.php" role="button" style="float:left;margin-left:100px;margin-top:100px; background-color:green">Use English Translator &raquo;</a></p>
