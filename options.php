<?php
	...
	$_SESSION["G_keyboard_value_no"] = null;
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
	<?php
		include 'header_page_option.php';
	?>
    <!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="jumbotron">
      <div class="container" style="margin-left:15%;">
		<form method="post" action="Translator.php" name="f1">
			<p>Choose your option :<font color="orange">&nbsp;</font> </p>
			<p style="left:15%"><a class="btn btn-primary btn-lg" href="new  2.php" role="button" style="float:left;margin-left:100px;margin-top:100px; background-color:green">Use English Translator &raquo;</a></p>
			<p style="left:15%"><a class="btn btn-primary btn-lg" href="First_page.php" role="button" style="float:left;	margin-left:50px;margin-top:100px;">ગુજરાતી વર્ચ્યુઅલ કીબોર્ડ &raquo;</a></p><br>
			<p style="left:15%"><a  href="#" style="margin-left:150px;margin-top:100px;">Help (મદદ) ? &raquo;</a></p>
		</form>
      </div>
	  <BR><BR>
    </div>
