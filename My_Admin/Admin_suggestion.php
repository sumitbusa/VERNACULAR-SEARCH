      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="Admin_suggestion.php">Suggestion Word</a></li>
		...
		<form method="post" action="check_box_opertaion_2.php">
            <table class="table table-striped">
              ...
              <tbody>
				...
				<button type="submit" class="btn btn-success">Add Word In Dictionary</button>
				<a href="Registration_page.php" style="margin-left:920px;">Insert A New Keyword &raquo;</a>
			</form>
          </div>
        </div>
      </div>
