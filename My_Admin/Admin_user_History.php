    ...
    <div class="container-fluid">
      <div class="row">
		...
		<!-- Check Whether Radio Button is Checked or not-->
          <h2 class="sub-header"><font color="green">select user name for find history of the user</font></h2>
          <div class="table-responsive">
		  <form method="post" onsubmit="return myFunction()" action="radio_button_opertaion.php">
            <table class="table table-striped">
              ...
              <tbody>
				...
				?>
                <tr>
                  <td><input type="radio" name="select_value" id="select_value" value="<?php echo $row["user_name"]; ?>" checked/></td>
				...
				<button type="submit" class="btn btn-success" >View the History</button>
				<a href="Registration_page.php" style="margin-left:70%;">Add another account &raquo;</a>
			</form>
          </div>
        </div>
      </div>
