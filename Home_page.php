...
================================================== -->
  <body>
      ...
      <div class="container">
        ...
        <form class="navbar-form navbar-right" method="post" action="verification_1.php">
            <div class="form-group"><!--/.navbar-collapse -->
		<?php
				//	}
			}
				else
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
         <img class="second-slide" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
              <h1><font color="green"> વર્ચ્યુઅલ કીબોર્ડ. </font></h1>
	...
	<div class="row">
		...
		<div class="col-lg-4">
			...
			<p><a class="btn btn-lg btn-primary" href="options.php" role="button" style="background-color:orange;">પ્રક્રિયા શરૂ કરો &raquo;</a></p>
		</div>
		<div class="col-lg-4">
			<!--<p><a class="btn btn-lg btn-primary" href="Guest_option.php" role="button" style="background-color:green">Guest User </a></p>-->
			<p><a class="btn btn-lg btn-primary" href="options.php" role="button" style="background-color:green;">Start Processing &raquo; &raquo;</a></p>
		</div>
		<!--<a href="#">
